layui.define(["jquery", "layer", "form"],
    function(e) {
        var y = layui.$,
            ...
            A = "dtree-icon-fuxuankuang",
            w = "dtree-icon-fuxuankuang-banxuan",
            q = "dtree-icon-move-down",
            L = "dtree-icon-move-up",
            R = "dtree-icon-refresh",
            O = "dtree-icon-roundcheckfill",
            _ = "dtree-icon-roundclosefill",
            E = "dtree-icon-roundcheck",
            F = "dtree-icon-delete1",
            M = "dtree-icon-search_list_light",
            H = "dtree-icon-pulldown",
            U = "dtree-icon-pullup",
            B = "dtree-icon-roundadd",
            V = "dtree-icon-bianji",
            W = "dtree-icon-roundclose",
            $ = {
                "-1": {
            ...
            de = {
                ...
                escape: function(e) {
                    return "string" != typeof e ? "": e.replace(ue.escape,
                        function(e) {
                            return he.escape[e]
                        })
                },
                unescape: function(e) {
                    return "string" != typeof e ? "": e.replace(ue.unescape,
                        function(e) {
            ...
            fe = function(a) {
                ...
                y.ajax({
                    ...
                    beforeSend: function(e, t) {
                        return "function" != typeof a.beforeSend || a.beforeSend(e, t)
                    },
                    success: a.success,
        ...
        be.prototype.setting = function(e) {
            this.options = e || {},
                this.elem = this.options.elem || b.elem || "",
                void 0 === this.options.obj ? this.elem && 0 < y(this.elem).length && (this.obj = y(this.elem)) : (this.obj = this.options.obj || b.obj || this.obj, this.elem = "#" + this.obj[0].id),
                this.scroll = this.options.scroll || b.scroll || this.elem,
                this.accordion = "boolean" == typeof this.options.accordion ? this.options.accordion: "boolean" == typeof b.accordion && b.accordion,
                this.accordion ? this.initLevel = 1 : this.initLevel = this.options.initLevel || b.initLevel || 2,
                this.type = this.options.type || b.type || "load",
                this.cache = "boolean" == typeof this.options.cache ? this.options.cache: "boolean" != typeof b.cache || b.cache,
                this.record = this.options.record || b.record || !1,
                this.load = "boolean" == typeof this.options.load ? this.options.load: "boolean" != typeof b.load || b.load,
                this.none = this.options.none || b.nont || "无数据",
                this.tempHeight = this.options.height || b.height,
                this.tempHeight ? /^full-\d+$/.test(this.tempHeight) ? (this.fullHeightGap = this.tempHeight.split("-")[1], this.height = u.height() - this.fullHeightGap) : (this.fullHeightGap = this.tempHeight, this.height = this.tempHeight) : (this.fullHeightGap = "", this.height = ""),
                this.width = this.options.width || b.width || "260",
                this.obj.css("width", this.width),
                this.iconfont = this.options.iconfont || b.iconfont || "dtreefont",
                this.iconfontStyle = this.options.iconfontStyle || b.iconfontStyle || {},
                this.nodeIconArray = y.extend($, this.options.nodeIconArray || b.nodeIconArray) || $,
                this.leafIconArray = y.extend(J, this.options.leafIconArray || b.leafIconArray) || J,
                this.skin = this.options.skin || b.skin || "theme",
                ...
                this.url = this.options.url || b.url || "",
                this.async = "boolean" == typeof this.options.async ? this.options.async: "boolean" != typeof b.async || b.async,
                this.asyncLoad = this.options.asyncLoad || b.asyncLoad || [],
                this.headers = this.options.headers || b.headers || {},
                this.method = this.options.method || b.method || "post",
                this.dataType = this.options.dataType || b.dataType || "json",
                this.contentType = this.options.contentType || b.contentType || "application/x-www-form-urlencoded",
                this.defaultRequest = y.extend(this.defaultRequest, this.options.defaultRequest || b.defaultRequest) || this.defaultRequest,
                this.filterRequest = this.options.filterRequest || b.filterRequest || [],
                this.request = this.options.request || b.request || {},
                this.response = y.extend(this.response, this.options.response || b.response) || this.response,
                this.data = this.options.data || b.data || null,
                this.dataFormat = this.options.dataFormat || b.dataFormat || "levelRelationship",
                this.dataStyle = this.options.dataStyle || b.dataStyle || "defaultStyle",
                this.errDataShow = this.options.errDataShow || b.errDataShow || !1,
                this.withCredentials = this.options.withCredentials || b.withCredentials || !1,
                this.beforeSend = this.options.beforeSend || b.beforeSend ||
                    function(e, t, o) {
                        return ! 0
                    },
                this.success = this.options.success || b.success ||
                    function(e, t, o) {},
                this.done = this.options.done || b.done ||
                    function(e, t, o) {},
                this.formatter = y.extend(this.formatter, this.options.formatter || b.formatter) || this.formatter,
                this.error = this.options.error || b.error ||
                    function(e, t, o) {},
                this.complete = this.options.complete || b.complete ||
                    function(e, t) {},
                this.checkbar = this.options.checkbar || b.checkbar || !1,
                this.checkbarLoad = this.options.checkbarLoad || b.checkbarLoad || "node",
                this.checkbarType = this.options.checkbarType || b.checkbarType || "all",
                this.checkbarData = this.options.checkbarData || b.checkbarData || "choose",
                this.checkbarFun = y.extend(this.checkbarFun, this.options.checkbarFun || b.checkbarFun) || this.checkbarFun,
                this.menubar = this.options.menubar || b.menubar || !1,
                this.menubarTips = y.extend(this.menubarTips, this.options.menubarTips || b.menubarTips) || this.menubarTips,
                this.menubarFun = y.extend(this.menubarFun, this.options.menubarFun || b.menubarFun) || this.menubarFun,
                this.toolbar = this.options.toolbar || b.toolbar || !1,
                this.toolbarWay = this.options.toolbarWay || b.toolbarWay || "contextmenu",
                this.toolbarStyle = y.extend(this.toolbarStyle, this.options.toolbarStyle || b.toolbarStyle) || this.toolbarStyle,
                this.toolbarLoad = this.options.toolbarLoad || b.toolbarLoad || "node",
                this.toolbarShow = this.options.toolbarShow || b.toolbarShow || ["add", "edit", "delete"],
                this.toolbarBtn = this.options.toolbarBtn || b.toolbarBtn || null,
                this.toolbarExt = this.options.toolbarExt || b.toolbarExt || [],
                this.toolbarFun = y.extend(this.toolbarFun, this.options.toolbarFun || b.toolbarFun) || this.toolbarFun,
                this.useIframe = this.options.useIframe || b.useIframe || !1,
                this.iframeElem = this.options.iframeElem || b.iframeElem || "",
                this.iframeUrl = this.options.iframeUrl || b.iframeUrl || "",
                this.iframeLoad = this.options.iframeLoad || b.iframeLoad || "leaf",
                this.iframeDefaultRequest = y.extend(this.iframeDefaultRequest, this.options.iframeDefaultRequest || b.iframeDefaultRequest) || this.iframeDefaultRequest,
                this.iframeRequest = y.extend(this.iframeRequest, this.options.iframeRequest) || y.extend(this.iframeRequest, b.iframeRequest) || this.iframeRequest,
                this.iframeFun = y.extend(this.iframeFun, this.options.iframeFun) || y.extend(this.iframeFun, b.iframeFun) || this.iframeFun,
                this.select = this.options.select || !1,
            this.select && this.selectSetting(),
                this.ensureTheme()
        },
            be.prototype.reloadSetting = function(e) {
                this.options = y.extend(this.options, e) || this.options,
                    ...
                    void 0 === this.options.obj ? this.elem && 0 < y(this.elem).length && (this.obj = y(this.elem)) : (this.obj = this.options.obj || this.obj, this.elem = "#" + this.obj[0].id),
                    this.scroll = this.options.scroll || this.scroll,
                    ...
                    this.tempHeight = this.options.height || this.height,
                this.tempHeight && (/^full-\d+$/.test(this.tempHeight) ? (this.fullHeightGap = this.tempHeight.split("-")[1], this.height = u.height() - this.fullHeightGap) : (this.fullHeightGap = this.tempHeight, this.height = this.tempHeight)),
                    ...
                    this.nodeIconArray = y.extend($, this.options.nodeIconArray) || this.nodeIconArray,
                    this.leafIconArray = y.extend(J, this.options.leafIconArray) || this.leafIconArray,
                    ...
                    this.asyncLoad = this.options.asyncLoad || this.asyncLoad,
                    ...
                    this.withCredentials = "boolean" == typeof this.options.withCredentials ? this.options.withCredentials: this.withCredentials,
                    this.beforeSend = this.options.beforeSend || this.beforeSend,
                    ...
                    this.iframeElem = this.options.iframeElem || this.iframeElem,
                    this.iframeUrl = this.options.iframeUrl || this.iframeUrl,
                    this.iframeLoad = this.options.iframeLoad || this.iframeLoad,
                    this.iframeDefaultRequest = y.extend(this.iframeDefaultRequest, this.options.iframeDefaultRequest) || this.iframeDefaultRequest,
                    this.iframeRequest = y.extend(this.iframeRequest, this.options.iframeRequest) || this.iframeRequest,
                    this.iframeFun = y.extend(this.iframeFun, this.options.iframeFun) || this.iframeFun,
                this.select && this.reloadSelectSetting(),
                    this.ensureTheme()
            },
            be.prototype.selectSetting = function() {
                this.select = !0,
                    this.selectInitVal = this.obj.attr("data-value") || this.options.selectInitVal || "",
                    this.selectTreeDiv = this.obj[0].id + "_tree_div",
                    this.selectCardDiv = this.obj[0].id + "_select_card_div",
                    this.selectDiv = this.obj[0].id + "_select_div",
                    this.selectTipsName = this.obj[0].id + "_select_input",
                    this.selectTips = this.options.selectTips || "请选择",
                    this.selectCardHeight = this.options.selectCardHeight || "350",
                    this.selectInputName = this.options.selectInputName || {
                        nodeId: this.obj[0].id + "_select_nodeId"
                    },
                    this.renderSelectDom()
            },
            be.prototype.reloadSelectSetting = function() {
                this.selectInitVal = this.obj.attr("data-value") || this.options.selectInitVal || this.selectInitVal,
                    this.selectTips = this.options.selectTips || this.selectTips,
                    this.selectCardHeight = this.options.selectCardHeight || this.selectCardHeight,
                    this.selectInputName = y.extend(this.selectInputName, this.options.selectInputName) || this.selectInputName,
            ...
            be.prototype.renderSelectDom = function() {
                ...
                e.obj.before(n);
                var s = "style=";
                this.selectCardHeight && (s += "'height:" + e.selectCardHeight + "px'"),
                    e.obj.wrap('<div class="layui-card dtree-select" dtree-id="' + t + '" dtree-card="' + e.selectCardDiv + '" ' + s + "></div>").wrap('<div class="layui-card-body"></div>').wrap('<div id="' + e.selectTreeDiv + '"></div>')
            },
            be.prototype.reloadSelectDom = function() {
                ...
                var s = "style=";
                this.selectCardHeight && (s += "'height:" + e.selectCardHeight + "px'"),
                    y("div[dtree-id='" + t + "'][dtree-card='" + e.selectCardDiv + "']").attr("style", s)
            },
            be.prototype.selectVal = function(e) {
                var t = this,
                    ...
                    i = "",
                    n = {};
                if (t.checkbar) return t.selectCheckboxVal();
                for (var s in void 0 === e && (e = t.getNowParam()), "string" == typeof e && (e = t.getParam(e)), i = e.context, a) n[a[s]] = e[s],
                    y("div[dtree-select='" + t.selectDiv + "']").find("input[dtree-id='" + o + "'][name='" + a[s] + "']").val(e[s] || "");
                return e.nodeId && !e.context && (i = t.getParam(e.nodeId)),
                    y("div[dtree-select='" + t.selectDiv + "']").find("input[dtree-id='" + o + "'][name='" + t.selectTipsName + "']").val(i || ""),
                    n
            },
            be.prototype.selectCheckboxVal = function() {
                var e = this,
                    t = e.obj[0].id,
                    o = e.selectInputName,
                    a = e.getCheckbarJsonArrParam();
                selectTipsNameValue = a.context;
                var i = {};
                for (var n in o) {
                    var s = a[n].join(",");
                    i[o[n]] = s,
                        y("div[dtree-select='" + e.selectDiv + "']").find("input[dtree-id='" + t + "'][name='" + o[n] + "']").val(s)
                }
                return y("div[dtree-select='" + e.selectDiv + "']").find("input[dtree-id='" + t + "'][name='" + e.selectTipsName + "']").val(selectTipsNameValue),
                    i
            },
            be.prototype.selectResetVal = function() {
                var e = this.obj[0].id;
                y("input[dtree-id='" + e + "']").val(""),
                    this.cancelNavThis(),
                this.checkbar && this.cancelCheckedNode()
            },
            be.prototype.ensureTheme = function() {
                this.style.item = G + this.skin + "-item",
                    this.style.itemThis = G + this.skin + "-item-this",
                    this.style.dfont = G + this.skin + "-dtreefont",
                    this.style.ficon = G + this.skin + "-ficon",
                    this.style.icon = G + this.skin + "-icon",
                    this.style.cbox = G + this.skin + "-checkbox",
                    this.style.chs = G + this.skin + "-choose";
                var e = this.iconfont,
                    t = [];
            ...
            be.prototype.useDefaultOrUserDefineCheckboxStyle = function(e, t) {
                ...
                if (void 0 === t) this.usefontStyle.checkbox.on = "" == o ? e + " " + P: o,
                    this.usefontStyle.checkbox.out = "" == a ? e + " " + A: a,
                    this.usefontStyle.checkbox.noall = "" == i ? e + " " + w: i;
                else {
                    var n = t.on,
                        s = t.out,
                        r = t.noall;
                    this.usefontStyle.checkbox.on = void 0 === n ? "" == o ? e + " " + P: o: e + " " + n,
                        this.usefontStyle.checkbox.out = void 0 === s ? "" == a ? e + " " + A: a: e + " " + s,
                        this.usefontStyle.checkbox.noall = void 0 === r ? "" == i ? e + " " + w: i: e + " " + r
                }
            },
            be.prototype.useDefaultOrUserDefineMenubarStyle = function(e, t) {
                ...
                if (void 0 === t) this.usefontStyle.menubar.movedown = "" == o ? e + " " + q: o,
                    this.usefontStyle.menubar.moveup = "" == a ? e + " " + L: a,
                    this.usefontStyle.menubar.refresh = "" == i ? e + " " + R: i,
                    this.usefontStyle.menubar.checkAll = "" == n ? e + " " + O: n,
                    this.usefontStyle.menubar.unCheckAll = "" == s ? e + " " + _: s,
                    this.usefontStyle.menubar.invertAll = "" == r ? e + " " + E: r,
                    this.usefontStyle.menubar.remove = "" == l ? e + " " + F: l,
                    this.usefontStyle.menubar.search = "" == d ? e + " " + M: d;
                else {
                    var c = t.movedown,
                        h = t.moveup,
                        u = t.refresh,
                        ...
                        m = t.remove,
                        y = t.search;
                    this.usefontStyle.menubar.movedown = void 0 === c ? "" == o ? e + " " + q: o: e + " " + c,
                        this.usefontStyle.menubar.moveup = void 0 === h ? "" == a ? e + " " + L: a: e + " " + h,
                        this.usefontStyle.menubar.refresh = void 0 === u ? "" == i ? e + " " + R: i: e + " " + u,
                        this.usefontStyle.menubar.checkAll = void 0 === f ? "" == n ? e + " " + O: n: e + " " + f,
                        this.usefontStyle.menubar.unCheckAll = void 0 === p ? "" == s ? e + " " + _: s: e + " " + p,
                        this.usefontStyle.menubar.invertAll = void 0 === b ? "" == r ? e + " " + E: r: e + " " + b,
                        this.usefontStyle.menubar.remove = void 0 === m ? "" == l ? e + " " + F: l: e + " " + m,
                        this.usefontStyle.menubar.search = void 0 === y ? "" == d ? e + " " + M: d: e + " " + y
                }
            },
            ...
            be.prototype.useDefaultOrUserDefineToolbarStyle = function(e, t) {
                ...
                if (void 0 === t) this.usefontStyle.toolbar.menubar.movedown = "" == o ? e + " " + this.usefontStyle.menubar.movedown: o,
                    ...
                    this.usefontStyle.toolbar.pulldown = "" == h ? e + " " + H: h,
                    this.usefontStyle.toolbar.pullup = "" == u ? e + " " + U: u,
                    this.usefontStyle.toolbar.add = "" == f ? e + " " + B: f,
                    this.usefontStyle.toolbar.edit = "" == p ? e + " " + V: p,
                    this.usefontStyle.toolbar.del = "" == b ? e + " " + W: b;
                else {
                    var m = t.menubar,
                        y = t.menubarExt,
                        v = t.pulldown,
                    ...
                    if (void 0 === m) this.usefontStyle.toolbar.menubar.movedown = "" == o ? e + " " + this.usefontStyle.menubar.movedown: o,
                        ...
                        this.usefontStyle.toolbar.menubar.movedown = void 0 === N ? "" == o ? e + " " + this.usefontStyle.menubar.movedown: o: e + " " + N,
                            ...
                            this.usefontStyle.toolbar.menubar.refresh = void 0 === T ? "" == i ? e + " " + this.usefontStyle.menubar.refresh: i: e + " " + T,
                            this.usefontStyle.toolbar.menubar.checkAll = void 0 === x ? "" == n ? e + " " + this.usefontStyle.menubar.checkAll: n: e + " " + x,
                    ...
                    this.usefontStyle.toolbar.menubarExt = void 0 === y ? "" == c ? this.usefontStyle.menubarExt: c: y,
                        this.usefontStyle.toolbar.pulldown = void 0 === v ? "" == h ? e + " " + H: h: e + " " + v,
                        this.usefontStyle.toolbar.pullup = void 0 === g ? "" == u ? e + " " + U: u: e + " " + g,
                        this.usefontStyle.toolbar.add = void 0 === k ? "" == f ? e + " " + B: f: e + " " + k,
                        this.usefontStyle.toolbar.edit = void 0 === S ? "" == p ? e + " " + V: p: e + " " + S,
                        this.usefontStyle.toolbar.del = void 0 === D ? "" == b ? e + " " + W: b: e + " " + D
                }
            },
            ...
            be.prototype.loadTreeInit = function() {
                var e = this,
                    t = e.asyncLoad;
                e.init(function() {
                    t && 0 < t.length && (e.obj.addClass(C), e.loadChildTreeInit(t, 0))
                })
            },
            be.prototype.loadChildTreeInit = function(e, t) {
                var o = this;
                if (t != e.length) {
                    var a = o.getNode(e[t]);
                    if (a && 0 < a.length) {
                        var i = a.next("ul"),
                            n = o.getNodeDom(a).fnode(),
                            s = o.getNodeDom(a).snode();
                        i.addClass(C),
                            o.accordionUL(i),
                            o.operateIcon(n, s).open(),
                            o.getChild(a, void 0,
                                function() {
                                    o.loadChildTreeInit(e, ++t)
                                })
                    }
                }
            },
            be.prototype.init = function(e) {
                var t = this;
                "object" == typeof t ? (t.autoHeight(), t.data ? t.dataLoadTree(!0, t.obj, t.data) : t.asyncLoadTree(!0, t.obj, e)) : f.msg("树组件未成功加载，请检查配置", {
                    icon: 5
                })
            },
            be.prototype.getChild = function(e, t, o) {
                var a = e.next("ul");
                this.setNodeParam(e),
                    void 0 !== t ? this.dataLoadTree(!1, a, t) : this.asyncLoadTree(!1, a, o)
            },
            be.prototype.dataLoadTree = function(a, i, n) {
                var s = this;
                if (void 0 !== n.length) if (a && 0 == n.length) i.html(s.getNoneDom().text());
                else {
                    i.html("");
                    var r = s.load ? f.load(1) : "";
                    setTimeout(function() {
                            s.success(n, i, a);
                            var e = 1 == a ? i.attr("data-id") : s.node.nodeId,
                                t = 1 == a ? 1 : parseInt(s.node.level) + 1;
                            if ("list" == s.dataFormat) {
                                var o = s.queryListTreeByPid(e, n);
                                s.loadListTree(o, s.data, t)
                            } else s.loadTree(n, t);
                            s.showLine(),
                            s.toolbar && "contextmenu" != s.toolbarWay && s.setToolbarDom().setToolbarPlace(s.toolbarMenu),
                                s.msgErrData(),
                            a && s.select && s.selectInitVal && (s.checkbar ? (s.chooseDataInit(s.selectInitVal), s.selectCheckboxVal(s.selectInitVal)) : (s.dataInit(s.selectInitVal), s.selectVal(s.selectInitVal))),
                                s.bak = s.obj.html(),
                                s.done(s.data, i, a),
                            s.load && f.close(r)
                        },
                        100)
                } else f.msg("数据解析异常，data数据格式不正确", {
                    icon: 5
                })
            },
            be.prototype.asyncLoadTree = function(s, r, l) {
                var d = this;
                if (d.url) {
                    r.html("");
                    var a = "";
                    fe({
                        ...
                        data: d.getFilterRequestParam(d.getRequestParam()),
                        beforeSend: function(e, t) {
                            a = d.load ? f.load(1) : "";
                            var o = d.beforeSend(this, e, t);
                            return o || d.load && f.close(a),
                                o
                        },
                        success: function(e) {
                            "string" == typeof e && (e = y.parseJSON(e)),
                                d.success(e, r, s);
                            var t = "";
                            if ((t = "layuiStyle" == d.dataStyle ? e[d.response.statusName] : e.status[d.response.statusName]) == d.response.statusCode) {
                                var o = e[d.response.rootName];
                                if (s && void 0 === o.length) return void r.html(d.getNoneDom().errText("数据解析异常，url回调后的数据格式不正确"));
                                if (s && 0 == o.length) return void r.html(d.getNoneDom().text());
                                var a = 1 == s ? r.attr("data-id") : d.node.nodeId,
                                    i = 1 == s ? 1 : parseInt(d.node.level) + 1;
                                if ("list" == d.dataFormat) {
                                    var n = d.queryListTreeByPid(a, o);
                                    s ? d.loadListTree(n, o, i) : d.loadListTree(n, o, i, r)
                                } else s ? d.loadTree(o, i) : d.loadTree(o, i, r);
                                d.showLine(),
                                d.toolbar && "contextmenu" != d.toolbarWay && d.setToolbarDom().setToolbarPlace(d.toolbarMenu),
                                    d.msgErrData(),
                                s || r.addClass(C),
                                s && d.select && d.selectInitVal && (d.checkbar ? (d.chooseDataInit(d.selectInitVal), d.selectCheckboxVal(d.selectInitVal)) : (d.dataInit(d.selectInitVal), d.selectVal(d.selectInitVal))),
                                    d.bak = d.obj.html(),
                                    d.done(e, r, s),
                                l && l()
                            } else "layuiStyle" == d.dataStyle ? (d.obj.html(d.getNoneDom().errText(e[d.response.message])), d.error(null, t, e[d.response.message])) : (d.obj.html(d.getNoneDom().errText(e.status[d.response.message])), d.error(null, t, e.status[d.response.message]))
                        },
                        error: function(e, t, o) {
                            d.obj.html(d.getNoneDom().errText(t + ": " + o)),
                                d.error(e, t, o)
                        },
                        complete: function(e, t) {
                            d.load && f.close(a),
            ...
            be.prototype.getDom = function(l, e, t, o, d, s, r, c, a, h, u, i) {
                var f = this,
                    p = f.obj[0].id,
                ...
                return {
                    ...
                    node: function() {
                        ...
                        if (r) {
                            var n = f.iconfont;
                            i = "string" == typeof n ? a = o = n + " " + r: (o = n[0] + " " + r, a = n[0] + " " + r, n[0] + " " + r)
                        }
                        return "-1" != e && "-1" != t ? d ? "<i class='" + o + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='last' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": h ? "<i class='" + a + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='open' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": "<i class='" + i + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='close' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": "-1" != e && "-1" == t ? d ? "<i class='" + o + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='last' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": h ? "<i class='" + a + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='open' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": "<i class='" + i + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='close' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": "-1" == e && "-1" != t ? d ? "<i class='" + o + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='last' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": h ? "<i class='" + a + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='open' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": "<i class='" + i + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='close' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": "-1" == e && "-1" == t ? d ? "<i class='" + o + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='last' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": h ? "<i class='" + a + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='open' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": "<i class='" + i + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='close' data-id='" + l + "' dtree-id='" + p + "' data-iconClass='" + r + "'></i>": void 0
                    },
                    checkbox: function() {
                        var e = !1;
                        if ("node" == f.checkbarLoad ? b && (e = !0) : d && b && (e = !0), e) {
                            var t = "<div class='" + D + "' data-id='" + l + "' dtree-id='" + p + "'>";
                            if (c && 0 < c.length) for (var o = 0; o < c.length; o++) {
                                var a = c[o],
                                    i = a[f.response.checked],
                                    n = a[f.response.type],
                                ...
                                var r = "";
                                u && (r = x),
                                    t += "<i class='" + s + " " + f.style.dfont + " " + f.style.cbox + " " + r + "' data-id='" + l + "' dtree-id='" + p + "' data-checked='" + i + "' data-initchecked='" + i + "' data-type='" + n + "' dtree-click='" + z + "' data-par='." + N + "' dtree-disabled='" + u + "'></i>"
                            }
                            return t += "</div>"
                        }
                        return ""
                    ...
                    text: function() {
                        var e = "";
                        return u && (e = x),
                        "<cite class='" + n + " " + e + "' data-id='" + l + "' data-leaf='" + (d ? "leaf": "node") + "' dtree-disabled='" + u + "' data-title='" + t + "' >" + o + "</cite>"
                    },
                    ul: function() {
                        return d ? "<ul class='" + m + "' data-id='" + l + "' dtree-id='" + p + "'></ul>": h ? "<ul class='" + m + " " + C + "' data-id='" + l + "' dtree-id='" + p + "'></ul>": "<ul class='" + m + "' data-id='" + l + "' dtree-id='" + p + "'></ul>"
                    }
                }
            },
            be.prototype.replaceDom = function(d, c, h, l, u, e) {
                var f = this,
                    p = f.obj[0].id,
                    b = (f.toolbar, f.checkbar);
                return {
                    ...
                    node: function(e) {
                        ...
                        "-1" != o && "-1" != a ? t = h ? "<i class='" + i + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='last' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": l ? "<i class='" + n + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='open' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": "<i class='" + s + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='close' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": "-1" != o && "-1" == a ? t = h ? "<i class='" + i + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='last' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": l ? "<i class='" + n + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='open' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": "<i class='" + s + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='close' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": "-1" == o && "-1" != a ? t = h ? "<i class='" + i + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='last' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": l ? "<i class='" + n + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='open' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": "<i class='" + s + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='close' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": "-1" == o && "-1" == a && (t = h ? "<i class='" + i + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='last' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": l ? "<i class='" + n + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='open' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>": "<i class='" + s + " " + v + " " + f.style.dfont + " " + f.style.icon + "' data-spread='close' data-id='" + c + "' dtree-id='" + p + "' data-iconClass='" + e + "'></i>"),
                        "" != t && f.getNodeDom(d).snode().replaceWith(y(t))
                    },
                    checkbox: function(e) {
                        var t = !1;
                        if ("node" == f.checkbarLoad ? b && (t = !0) : h && b && (t = !0), t) {
                            var o = "<div class='" + D + "' data-id='" + c + "' dtree-id='" + p + "'>";
                            if (e && 0 < e.length) for (var a = 0; a < e.length; a++) {
                                var i = e[a],
                                    n = i[f.response.checked],
                                    s = i[f.response.type],
                                    r = f.usefontStyle.checkbox.out;
                                r = "2" == n ? f.usefontStyle.checkbox.noall + " " + f.style.chs: "1" == n ? f.usefontStyle.checkbox.on + " " + f.style.chs: f.usefontStyle.checkbox.out;
                                var l = "";
                                u && (l = x),
                                    o += "<i class='" + r + " " + f.style.dfont + " " + f.style.cbox + " " + l + "' data-id='" + c + "' dtree-id='" + p + "' data-checked='" + n + "' data-initchecked='" + n + "' data-type='" + s + "' dtree-click='" + z + "' data-par='." + N + "' dtree-disabled='" + u + "'></i>"
                            }
                            o += "</div>",
                                f.getNodeDom(d).snode().next("div").replaceWith(y(o))
                        }
                    },
                    text: function(e) {
                        var t = "";
                        u && (t = x);
                        var o = "<cite class='" + n + " " + t + "' data-id='" + c + "' data-leaf='" + (h ? "leaf": "node") + "' dtree-disabled='" + u + "' >" + e + "</cite>";
                        f.getNodeDom(d).cite().replaceWith(y(o))
                    },
                    ul: function() {
                        var e = h ? "<ul class='" + m + "' data-id='" + c + "' dtree-id='" + p + "'></ul>": l ? "<ul class='" + m + " " + C + "' data-id='" + c + "' dtree-id='" + p + "'></ul>": "<ul class='" + m + "' data-id='" + c + "' dtree-id='" + p + "'></ul>";
                        f.getNodeDom(d).nextUl().replaceWith(y(e))
                    },
                    div: function() {
                        d.attr("data-id", c)
                    },
                    ...
                    recordData: function(e) {
                        e = "{}" == e ? "": e,
                            d.attr("data-record", e)
                    },
                    p_li: function(e) {
                        var t = d.parent("li");
                        return t.attr("data-id", c),
                        e && t.attr("data-pid", e),
                            t
                    }
                }
            ...
            be.prototype.dataInit = function(e) {
                ...
                if (o && 0 < o.length) {
                    t.obj.find("." + i).removeClass(i),
                        t.obj.find("." + t.style.itemThis).removeClass(t.style.itemThis),
                        o.addClass(i),
                        o.addClass(t.style.itemThis),
                        t.setNodeParam(o);
                    var a = o.parents("." + k);
                    a.children("ul").addClass(C),
                        a.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.fnode.node.close)).addClass(t.usefontStyle.fnode.node.open),
                        a.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.fnode.node.close)).removeClass(t.usefontStyle.fnode.node.close),
                        a.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.snode.node.close)).addClass(t.usefontStyle.snode.node.open),
                        a.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.snode.node.close)).removeClass(t.usefontStyle.snode.node.close)
                }
                return t.getNowParam()
            },
            ...
            be.prototype.cancelNavThis = function() {
                this.obj.find("div[data-id]").parent().find("." + i).removeClass(i),
                    this.obj.find("div[data-id]").parent().find("." + this.style.itemThis).removeClass(this.style.itemThis)
            },
            ...
            be.prototype.setDisabledNodes = function(e) {
                var t = [];
                if (t = "string" == typeof e ? e.split(",") : e, e.length) for (var o = 0; o < t.length; o++) this.setDisabledNode(this.getNodeDom(t[o]).div());
                else this.setDisabledNode(this.getNodeDom(t + "").div())
            },
            be.prototype.setDisabledAllNodes = function() {
                var t = this;
                t.obj.find("div[dtree-click='" + X + "']").each(function() {
                    var e = y(this);
                    t.setDisabledNode(e)
                })
            },
            be.prototype.setDisabledNode = function(e) {
                var t = e.children("div." + D).children("i[data-par]"),
                    o = e.children("cite[data-leaf]");
            ...
            be.prototype.cancelDisabledNodes = function(e) {
                var t = [];
                if (t = "string" == typeof e ? e.split(",") : e, e.length) for (var o = 0; o < t.length; o++) this.cancelDisabledNode(this.getNodeDom(t[o]).div());
                else this.cancelDisabledNode(this.getNodeDom(t + "").div())
            },
            be.prototype.cancelDisabledNode = function(e) {
                var t = e.children("div." + D).children("i[data-par]"),
                    o = e.children("cite[data-leaf]");
                null != e && "true" == e.attr("dtree-disabled") && (e.attr("dtree-disabled", "false"), t.attr("dtree-disabled", "false"), t.removeClass(x), o.attr("dtree-disabled", "false"), o.removeClass(x))
            },
            be.prototype.getDisabledNodesParam = function(e) {
                ...
                var a = [];
                if (e.length) for (var i = 0; i < o.length; i++) {
                    var n;
                    null != (n = t.getNodeDom(o[i]).div()) && "true" == n.attr("dtree-disabled") && a.push(t.getRequestParam(t.getTempNodeParam(n)))
                } else null != (n = t.getNodeDom(o + "").div()) && "true" == n.attr("dtree-disabled") && a.push(t.getRequestParam(t.getTempNodeParam(n)));
                return a
            },
            ...
            be.prototype.setHideNodes = function(e) {
                var t = [];
                if ((t = "string" == typeof e ? e.split(",") : e).length) for (var o = 0; o < t.length; o++) this.setHideNode(this.getNodeDom(t[o]).div());
                else this.setHideNode(this.getNodeDom(t + "").div())
            },
            be.prototype.setHideNode = function(e) {
                var t = e.parent("li[dtree-hide]");
                null != e && "true" != e.attr("dtree-hide") && (e.attr("dtree-hide", "true"), t.attr("dtree-hide", "true"), t.addClass(T))
            },
            be.prototype.cancelHideNodes = function(e) {
                var t = [];
                if ((t = "string" == typeof e ? e.split(",") : e).length) for (var o = 0; o < t.length; o++) this.cancelHideNode(this.getNodeDom(t[o]).div());
                else this.cancelHideNode(this.getNodeDom(t + "").div())
            },
            be.prototype.cancelHideNode = function(e) {
                var t = e.parent("li[dtree-hide]");
                null != e && "true" == e.attr("dtree-hide") && (e.attr("dtree-hide", "false"), t.attr("dtree-hide", "false"), t.removeClass(T))
            },
            be.prototype.getHideNodesParam = function(e) {
                var t = this,
                    o = [],
                    a = [];
                if ((o = "string" == typeof e ? e.split(",") : e).length) for (var i = 0; i < o.length; i++) {
                    var n;
                    null != (n = t.getNodeDom(o[i]).div()) && "true" == n.attr("dtree-hide") && a.push(t.getRequestParam(t.getTempNodeParam(n)))
                } else null != (n = t.getNodeDom(o + "").div()) && "true" == n.attr("dtree-hide") && a.push(t.getRequestParam(t.getTempNodeParam(n)));
                return a
            },
            ...
            be.prototype.partialRefreshEdit = function(e, t) {
                ...
                if ($ul = e.next("ul"), $p_li = e.parent("li"), t) if ("object" == typeof t) {
                    ...
                    if (a.treeId()) {
                        ...
                        var n = a.parentId(),
                            s = $p_li.attr("data-pid");
                        if (n && n != s) {
                            $p_li = i.p_li(n);
                            var r = o.getNodeDom(n).div(),
                                l = o.getNodeDom(n).nextUl();
                            if (0 == l.children("li").length) {
                                var d = r.find("i[data-spread]");
                                o.operateIcon(d.eq(0), d.eq(1)).openWithLeaf(),
                                    l.addClass(C)
                            }
                            l.append($p_li)
                        } else i.p_li();
            ...
            be.prototype.fuzzySearch = function(e) {
                var a = this;
                if ("" != e.trim()) {
                    a.obj.find("li").addClass("layui-hide").attr("dtree-hide", !0);
                    a.filterMode;
                    a.obj.find("li>div cite:contains('" + e + "')").each(function(e, t) {
                        var o = y(t).parent().parent();
                        a.getParam(o.attr("data-id"));
                        o.removeClass("layui-hide").attr("dtree-hide", !1),
                            o.find("ul li").removeClass("layui-hide").attr("dtree-hide", !1),
                            o.parents("li").removeClass("layui-hide").attr("dtree-hide", !1)
                    })
                } else a.obj.find("li").removeClass("layui-hide").attr("dtree-hide", !1)
            },
            be.prototype.chooseDataInit = function(e) {
                var t = this,
                    o = [],
                    a = [];
                if ((a = "string" == typeof e ? e.split(",") : e).length) {
                    for (var i = 0; i < a.length; i++) {
                        var n = a[i];
                        "string" != typeof e && n.length && o.push(n)
                    }
                    0 == o.length && o.push(a);
                    for (i = 0; i < o.length; i++) for (var s = o[i], r = 0; r < s.length; r++) {
                        var l = t.obj.find("i[dtree-click='" + z + "'][data-type=" + i + "][data-id=" + s[r] + "]");
                        t.checkStatus(l).check()
                    }
                } else {
                    l = t.obj.find("i[dtree-click='" + z + "'][data-id=" + a + "]");
                    t.checkStatus(l).check()
                }
                var d = t.obj.find("i[dtree-click='" + z + "'][data-checked='1']").parents("." + k);
                return d.children("ul").addClass(C),
                    d.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.fnode.node.close)).addClass(t.usefontStyle.fnode.node.open),
                    d.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.fnode.node.close)).removeClass(t.usefontStyle.fnode.node.close),
                    d.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.snode.node.close)).addClass(t.usefontStyle.snode.node.open),
                    d.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.snode.node.close)).removeClass(t.usefontStyle.snode.node.close),
            ...
            be.prototype.changeCheck = function(e) {
                var t = this,
                    o = t.temp;
                void 0 === e && (e = o[0]),
                    "all" == t.checkbarType ? t.checkAllOrNot(e) : "no-all" == t.checkbarType ? t.checkAllOrNoallOrNot(e) : "p-casc" == t.checkbarType ? t.checkAllOrPcascOrNot(e) : "self" == t.checkbarType ? t.checkOrNot(e) : "only" == t.checkbarType ? t.checkOnly(e) : t.checkAllOrNot(e),
                t.select && t.selectCheckboxVal();
                var a = t.setAndGetCheckbarNodesParam(!0);
                t.checkbarFun.chooseDone(a),
                    layui.event.call(this, p, "chooseDone(" + y(t.obj)[0].id + ")", {
                        checkbarParams: a
                    }),
                    t.temp = []
            },
            ...
            be.prototype.setAndGetCheckbarNodesParam = function(o) {
                var a = this;
                return a.checkbarNode = [],
                    "change" == a.checkbarData ? a.obj.find("i[data-par][dtree-disabled='false']").each(function() {
                        var e = y(this),
                            t = e.closest("." + S);
            ...
            be.prototype.getCheckbarNodeParam = function(e, t) {
                ...
                i && (i = JSON.parse(de.unescape(i))),
                    a.basicData = i;
                var n = e.attr("data-record");
                return n && (n = JSON.parse(de.unescape(n))),
                    a.recordData = n,
            ...
            be.prototype.getCheckbarJsonArrParam = function() {
                ...
                if (t && 0 < t.length) for (var o = 0; o < t.length; o++) {
                    var a = t[o];
                    e.nodeId.push(a.nodeId),
                        e.parentId.push(a.parentId),
                        e.context.push(a.context),
                        e.leaf.push(a.leaf),
                        e.level.push(a.level),
                        e.spread.push(a.spread),
                        e.dataType.push(a.dataType),
                        e.checked.push(a.checked),
                        e.initchecked.push(a.initchecked),
                        e.basicData.push(a.basicData),
                        e.recordData.push(a.recordData)
                }
                return e = this.getRequestParam(e)
            },
            be.prototype.changeCheckbarNodes = function() {
                return this.obj.find("i[data-par]").each(function() {
                    var e = y(this);
                    if ($div = e.closest("." + S), e.attr("data-checked") != e.attr("data-initchecked")) return ! 0
                }),
                    !1
            },
            ...
            be.prototype.checkAllNode = function() {
                var e = this.obj.find("i[data-par][data-checked!='1']");
                0 < e.length && this.checkStatus(e).check()
            },
            be.prototype.cancelCheckedNode = function() {
                var e = this.obj.find("i[data-par][data-checked!='0']");
                0 < e.length && this.checkStatus(e).noCheck()
            },
            be.prototype.invertCheckedNode = function() {
                var t = this;
            ...
            be.prototype.removeCheckedNode = function() {
                var o = this;
                if (0 == o.obj.find("i[data-par][data-checked='1']").length) f.msg("请至少选中一个节点", {
                    icon: 2
                });
                else {
                    o.checkbarNode = [];
                    o.obj.find("i[data-par][data-checked='1']").each(function() {
                        ...
                        f.confirm("确定要删除选中节点？", {
                            ...
                            function(e) {
                                o.menubarFun.remove(o.checkbarNode) && (o.obj.find("i[data-par][data-checked='1']").closest("." + S).next("ul").remove(), o.obj.find("i[data-par][data-checked='1']").closest("." + S).remove(), o.checkbarNode = []),
                                    f.close(e)
                            })
                }
            },
            ...
            be.prototype.getToolbarDom = function() {
                ...
                if (0 < t.length) for (var a = 0; a < t.length; a++) {
                    var i = t[a];
                    "pulldown" == i && (e.toolbarMenu[K] = e.setToolbarDom().setToolbarOption(K, e.toolbarStyle.title, e.usefontStyle.toolbar.pulldown, "展开")),
                    "pullup" == i && (e.toolbarMenu[Q] = e.setToolbarDom().setToolbarOption(Q, e.toolbarStyle.title, e.usefontStyle.toolbar.pullup, "收缩")),
                    "add" == i && (e.toolbarMenu[Y] = e.setToolbarDom().setToolbarOption(Y, e.toolbarStyle.title, e.usefontStyle.toolbar.add, "新增")),
                    "edit" == i && (e.toolbarMenu[Z] = e.setToolbarDom().setToolbarOption(Z, e.toolbarStyle.title, e.usefontStyle.toolbar.edit, "编辑")),
                    "delete" == i && (e.toolbarMenu[ee] = e.setToolbarDom().setToolbarOption(ee, e.toolbarStyle.title, e.usefontStyle.toolbar.del, "删除"))
                }
            ...
            be.prototype.toolbarListener = function(e, d) {
                var c = this,
                    ...
                    n = "function" == typeof c.formatter.title ? a.attr("data-title") : a.text();
                switch (e) {
                    case K:
                    ...
                    case Y:
                        var n = [{
                                ...
                                },
                                {
                                    ...
                                    value: "确认添加",
                                    defElem: "btn",
                                    filter: "dtree_addNode_" + o.obj[0].id + "_form"
                                }],
                            s = ['<div class="' + g + '"><form class="layui-form layui-form-pane" lay-filter="dtree_addNode_' + o.obj[0].id + '_form">'];
                    ...
                    case Z:
                        var h = [{
                                ...
                                },
                                {
                                    ...
                                    value: "确认编辑",
                                    defElem: "btn",
                                    filter: "dtree_editNode_" + o.obj[0].id + "_form"
                                }],
                            u = ['<div class="' + g + '"><form class="layui-form layui-form-pane" lay-filter="dtree_editNode_' + o.obj[0].id + '_form">'];
                ...
                if (e) {
                    ...
                    if ("object" == typeof e) {
                        ...
                        i.append(t.getLiItemDom(d.treeId(), d.parentId(), d.title(), d.fmtTitle(), d.last(0), d.ficonClass(), d.iconClass(), d.checkArr(), s, d.spread(), d.disabled(), d.hide(), d.basicData(), d.recordData(), "item")),
                            ...
                            t.setNodeParam(l)
                    } else "refresh" == e || 1 == e ? r = !0 : "string" != typeof e && "number" != typeof e || (l.attr("data-id", e), i.find("li[data-id='" + e + "']").show(), t.setNodeParam(l));
        ...
        be.prototype.changeTreeNodeDone = function(e) {
            r.val("dtree_editNode_" + this.obj[0].id + "_form", e),
                r.render()
        },
        ...
        be.prototype.loadIframe = function(e, t) {
            ...
            var i = o.iframeElem,
                n = o.iframeUrl,
                s = "leaf" != o.iframeLoad || "leaf" == a.attr("data-leaf");
            if (s) {
                ...
                if (!n) return f.msg("数据请求异常，iframeUrl参数未指定", {
                    ...
                    !1;
                var r = pe("?", t); - 1 < n.indexOf("?") && (r = "&" + r.substring(1, r.length));
                var l = n + r;
                y(i).attr("src", l)
            }
            return s
        ...
        be.prototype.getIframeRequestParam = function(e) {
            var t = this.iframeRequest,
                o = this.iframeDefaultRequest,
                a = e || this.node,
                i = {};
        ...
        be.prototype.setNodeParam = function(e) {
            var t = this;
            t.node.nodeId = e.attr("data-id"),
                t.node.parentId = t.getNodeDom(e).parentLi().attr("data-pid"),
                t.node.context = "function" == typeof t.formatter.title ? t.getNodeDom(e).cite().attr("data-title") : t.getNodeDom(e).cite().text(),
                t.node.leaf = "leaf" == t.getNodeDom(e).cite().attr("data-leaf"),
                t.node.level = t.getNodeDom(e).parentLi().attr("data-index"),
                t.node.spread = "open" == t.getNodeDom(e).fnode().attr("data-spread");
            var o = e.attr("data-basic");
            o && (o = JSON.parse(de.unescape(o))),
                t.node.basicData = o;
            ...
            if (a && (a = JSON.parse(de.unescape(a))), t.node.recordData = a, t.getNodeDom(e).checkbox()) {
                ...
                t.getNodeDom(e).checkbox().each(function() {
                    i += y(this).attr("data-type") + ",",
                        n += y(this).attr("data-checked") + ",",
        ...
        be.prototype.getTempNodeParam = function(e) {
            var t = this,
                o = {};
            o.nodeId = e.attr("data-id"),
                o.parentId = t.getNodeDom(e).parentLi().attr("data-pid"),
                o.context = "function" == typeof t.formatter.title ? t.getNodeDom(e).cite().attr("data-title") : t.getNodeDom(e).cite().text(),
                o.leaf = "leaf" == t.getNodeDom(e).cite().attr("data-leaf"),
                o.level = t.getNodeDom(e).parentLi().attr("data-index"),
                o.spread = "open" == t.getNodeDom(e).fnode().attr("data-spread");
            var a = e.attr("data-basic");
            a && (a = JSON.parse(de.unescape(a))),
                o.basicData = a;
            ...
            if (i && (i = JSON.parse(de.unescape(i))), o.recordData = i, t.getNodeDom(e).checkbox()) {
                var n = "",
                    ...
                    r = "";
                t.getNodeDom(e).checkbox().each(function() {
                    n += y(this).attr("data-type") + ",",
                        s += y(this).attr("data-checked") + ",",
        ...
        be.prototype.bindBrowserEvent = function() {
            ...
            s.obj.on("click", "i[data-spread]",
                function(e) {
                    ...
                    s.toolbarHide(),
                        s.navThis(o),
                        s.clickSpread(o),
                        layui.event.call(this, p, "changeTree(" + y(s.obj)[0].id + ")", {
                            dom: s.callbackData().dom(t),
                            param: s.callbackData().node(a),
                            show: "open" == s.callbackData().dom(t).attr("data-spread")
                        })
                }),
                s.obj.on("click", "div[dtree-click='" + X + "'][dtree-disabled='false']",
                    function(e) {
                        e.stopPropagation();
                        var t = y(this),
                ...
                s.obj.on("dblclick", "div[dtree-click='" + X + "'][dtree-disabled='false']",
                    function(e) {
                        e.stopPropagation();
                        var t = y(this),
                            o = (t.find("cite"), s.getNodeParam(t));
                        s.toolbarHide(),
                            s.navThis(t),
                        s.select && (s.selectVal(o.nodeId), y("div[dtree-id='" + i + "'][dtree-select='" + s.selectDiv + "']").click()),
                            layui.event.call(this, p, "nodedblclick(" + y(s.obj)[0].id + ")", {
                                param: s.callbackData().node(o),
                                childParams: s.callbackData().childNode(t),
                                parentParam: s.callbackData().parentNode(t),
                                dom: s.callbackData().dom(t)
            ...
            s.checkbar && s.obj.on("click", "i[dtree-click='" + z + "'][dtree-disabled='false']",
                function(e) {
                    s.toolbarHide();
                    var t = y(this),
                        o = t.closest("div[dtree-click='" + X + "']"),
                        a = s.getNodeParam(o),
            ...
            s.toolbar && ("contextmenu" == s.toolbarWay ? (s.obj.on("contextmenu", "div[dtree-click='" + X + "'][d-contextmenu='true'][dtree-disabled='false']",
                function(e) {
                    var t = y(this),
                        o = s.getNodeParam(t);
                    s.toolbarHide(),
                        s.setToolbarDom().setToolbarPlace(s.toolbarFun.loadToolbarBefore(de.cloneObj(s.toolbarMenu), s.getRequestParam(o), t));
                ...
                }) : "follow" == s.toolbarWay && (s.obj.on("mouseover mouseout", "div[dtree-click='" + X + "'][dtree-disabled='false']",
                function(e) {
            ...
            s.select && y("div[dtree-id='" + i + "'][dtree-select='" + s.selectDiv + "']").on("click",
                function(e) {
                    e.stopPropagation();
                    y(this).find("dl");
                    y(this).toggleClass("layui-form-selected");
                    var t = y("div[dtree-id='" + i + "'][dtree-card='" + s.selectCardDiv + "']");
                    t.toggleClass("dtree-select-show layui-anim layui-anim-upbit");
                    var o = y(this).offset().top + y(this).outerHeight() - u.scrollTop() - 5,
                        a = t.height();
                    u.height();
                    t.hasClass("dtree-select-up") && t.removeClass("dtree-select-up"),
                        o + a > u.height() && a <= o ? (console.log(" top + cardHeight : " + o + " + " + a + " > $WIN.height() :" + u.height() + " && top >= cardHeight :" + o + " > " + a), t.hasClass("dtree-select-up") ? t.removeClass("dtree-select-up") : t.addClass("dtree-select-up")) : t.removeClass("dtree-select-up"),
                        layui.event.call(this, p, "changeSelect(" + y(s.obj)[0].id + ")", {
        ...
        be.prototype.unbindBrowserEvent = function() {
            ...
            e.toolbar && "contextmenu" == e.toolbarWay && (e.obj.prevAll("div#dtree_toolbar_" + e.obj[0].id).unbind(), 0 < e.obj.closest(e.scroll).length && e.obj.closest(e.scroll).unbind()),
            e.select && (y("div[dtree-id='" + e.obj[0].id + "'][dtree-select='" + e.selectDiv + "']").removeClass("layui-form-selected"), y("div[dtree-id='" + e.obj[0].id + "'][dtree-card='" + e.selectCardDiv + "']").removeClass("dtree-select-show layui-anim layui-anim-upbit"), y("div[dtree-id='" + e.obj[0].id + "'][dtree-select='" + e.selectDiv + "']").unbind())
        },
        layui.link(layui.cache.base + 'dtree/layui.dtree.css'),
        ...
        e("dtree", {
            ...
            render: function(e) {
                ...
                return "" == o ? f.msg("页面中未找到绑定id", {
                    icon: 5
                }) : ("object" == typeof(t = j[o]) && t.unbindBrowserEvent(), t = new be(e), (j[o] = t).initTreePlus(), t.openTreePlus(), t.loadTreeInit(), t.bindBrowserEvent()),
                    t
            },
            renderSelect: function(e) {
                ...
                return "" == o ? f.msg("页面中未找到绑定id", {
                    icon: 5
                }) : ("object" == typeof(t = j[o]) && t.unbindBrowserEvent(), (t = new be(e)).selectSetting(), (j[o] = t).initTreePlus(), t.openTreePlus(), t.loadTreeInit(), t.bindBrowserEvent()),
                    t
            },
            reload: function(e, t) {
                "string" == typeof e && (e = j[e]),
                    void 0 !== e ? (e.reloadSetting(t), e.initTreePlus(), e.openTreePlus(), e.initNodeParam(), e.loadTreeInit(), e.unbindBrowserEvent(), e.bindBrowserEvent()) : f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                        icon: 2
                    })
            },
            on: function(e, t) {
                ...
                0 < e.indexOf('"') && (e = e.replace(/"/g, "")),
                    layui.onevent.call(this, p, e, t)
            },
            click: function(e, t) {
                "string" == typeof e && (e = j[e]),
                    void 0 !== e ? y("div[dtree-click='" + X + "'][dtree-id='" + e.obj[0].id + "'][data-id='" + t + "']").click() : f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                        icon: 2
                    })
            },
            getNowParam: function(e) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return e.getNowParam();
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            getParam: function(e, t) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return e.getParam(t);
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            getParentParam: function(e, t) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return e.getParentParam(t);
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            getAllParentParam: function(e, t) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return e.getAllParentParam(t);
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            getChildParam: function(e, t) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return e.getChildParam(t);
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            ...
            getCheckbarJsonArrParam: function(e) {
                return "string" == typeof e && (e = j[e]),
                    void 0 === e ? (f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                        icon: 2
                    }), {}) : e.getCheckbarJsonArrParam()
            },
            dataInit: function(e, t) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return t ? e.dataInit(t) : void 0;
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            chooseDataInit: function(e, t) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return t ? e.chooseDataInit(t) : void 0;
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            changeCheckbarNodes: function(e) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return e.changeCheckbarNodes();
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            initNoAllCheck: function(e) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return e.initNoAllCheck();
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            initAllCheck: function(e) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return e.initAllCheck();
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
            selectVal: function(e, t) {
                if ("string" == typeof e && (e = j[e]), void 0 !== e) return e.selectVal(t);
                f.msg("方法获取失败，请检查ID或对象传递是否正确", {
                    icon: 2
                })
            },
