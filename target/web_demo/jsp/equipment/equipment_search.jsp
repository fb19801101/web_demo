        ...
        <div class="layui-input-inline">
          <select id="piId" name="piId" lay-verify="required" lay-search="" lay-filter="selectPartItem">
            ...
            <c:forEach var="pi" items="${message['lstPartItem']}">
              <option value="${pi.piName}" <c:if test="${pi.piId == message['equipment'].piId}"> selected = "yes"</c:if>>${pi.piId}--${pi.piName}</option>
            </c:forEach>
          </select>
        </div>
      </div>
        ...
        <div class="layui-input-inline">
          <select id="clId" name="clId" lay-verify="required" lay-search="" lay-filter="selectCostLayer">
            ...
            <c:forEach var="cl" items="${message['lstCostLayer']}">
              <option value="${cl.clCode}" <c:if test="${cl.clId == message['equipment'].clId}"> selected = "yes"</c:if>>${cl.clId}--${cl.clName}</option>
            </c:forEach>
          </select>
        </div>
      </div>
