layui.define(['table', 'jquery', 'form'], function (exports) {
     ...
     * 初始化表格选择器
     */
    DSelect.prototype.render = function (opt) {
        var elem = $(opt.elem);
        ...
        elem.off('click').on('click', function(e) {
            ...
            var _table = table.render(opt.table);
     ...
     * 隐藏选择器
     */
    DSelect.prototype.hide = function (opt) {
        $('.tableSelect').remove();
    };

    //自动完成渲染
    var _dselect = new DSelect();
